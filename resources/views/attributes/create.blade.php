    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fas fa-table"></i> Add Attribute
  			</div>
        <div class="card-body">
          <form id="attrForm" action="{{ url('attributes/add') }}" enctype="multipart/form-data" method="post">
            ...
            <div class="col-md-6">
                ...
                <div class="form-label-group">
                  <input type="text" id="name" name="name" class="form-control" placeholder="Attribute Name"  autofocus>
